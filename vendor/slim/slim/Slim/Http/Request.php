...
class Request extends Message implements ServerRequestInterface
{
    ...
    public function getParsedBody()
    {
        ...
        if (!isset($this->bodyParsers[$mediaType])) {
            ...
            if (preg_match('/\+/', $mediaType)) {
                // Ambil bagian setelah '+' (struktur tipe media)
                $plusPos = strpos($mediaType, '+'); // Still used to find position
                $mediaType = 'application/' . substr($mediaType, $plusPos + 1);
            }
        }
